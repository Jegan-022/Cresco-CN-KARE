export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    const bullets = [
      ...
      `Exam Key Rule: Master the packet exchange sequence, flag values, and timeout implications of ${lessonTitle || 'the lesson'} for the exam.`
    ];
    const keyConcept = keyTakeaway || lessonTitle || 'Computer Networks Principle';
